            ...
            <span class="icon">
              <?php 
                $icons = [
                  ...
                  'login_audit.php' => '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a9 9 0 109 9 9 9 0 00-9-9zm1 13h-2v-2h2zm0-4h-2V7h2z"/></svg>',
          ...
          <h1>
            <?php 
              $page_titles = [
                ...
                'reports.php' => 'Reports & Analytics',                'login_audit.php' => 'Login Audit',                'users.php' => 'User Management'
              ];
